...
#| fig-height: 3
#| out-width: 33%
#| fig-cap: "A **[ggnetwork](https://cran.r-project.org/web/packages/ggnetwork/)** example."
library("ggnetwork")
g1df = ggnetwork(g1)
...
ggplot(ggeo09, aes(x = x, y = y)) +
  ...
  geom_label(data = dfctrans, aes(x = lonc, y = latc, label = labc, fill = labc), 
             colour = "white", alpha = 0.7, size = 3) +
